...
Realizamos este experimento tanto sobre instancias como sobre características. Para eso, debimos elaborar un corpus etiquetado de instacias relacionándolas a una o varias clases.
